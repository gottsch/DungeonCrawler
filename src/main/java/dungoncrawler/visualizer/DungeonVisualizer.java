...
import dungoncrawler.generator.dungeon.Corridor;
import dungoncrawler.generator.dungeon.DungeonLevel;
import dungoncrawler.generator.dungeon.DungeonLevelGenerator;
import dungoncrawler.generator.dungeon.IRoom;
import dungoncrawler.generator.dungeon.Room;
import dungoncrawler.generator.dungeon.RoomFlag;
import dungoncrawler.generator.dungeon.RoomRole;
		...
		rooms.forEach(room -> {
			...
			for (int w = 0; w < room.getBox().getWidth(); w++) {
				for (int d = 0; d < room.getBox().getHeight(); d++) {
					...
					// don't mark the walls as true since corridors can run thru the walls and need to show up
